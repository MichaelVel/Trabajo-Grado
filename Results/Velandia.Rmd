...
se ha ido deteríorando a raíz del  rápido crecimiento de las poblaciones humanas,
...
Colombia pez capitán de la sabana (*Eremophilus mutisii*)” liderado por el Ministerío del
...
```{r sampling estation, message=FALSE, warning=FALSE, cache=TRUE, fig.height= 4, fig.width= 6, fig.align='center', echo=FALSE, fig.cap= " Localización espacial de las estaciones de muestreo. El area de muestreo del rio frio se ubico en la cuenca baja del rio Frío (izquierda), municipio de Cajicá y municipio  de Chia, Longitud del recorrido aprox 13,5 km . El area de muestreo del rio Neusa tiene ubicado en el municipio de Cogua, tiene puntos de muestreo antes y despues de la represa del Neusa. Longitud del recorrido aprox 13 km"}
...
observaciones y mediciones directas en el laboratorío, apoyadas en una revisión 
...
de Cajicá forman un grupo (FríoB) y la estación ubicada en la zona urbana de Chía
forma el otro (FríoA). En el río Neusa se observa una diferencia de las estaciones
...
por lo que fueron excluidas de los análisis posteríores.  
...
Las mediciones de pH realizadas en el río Frío muestran una  alta variabilidad
...
estaciones anteríores a la represa (Neusa A) presentan valores más elevados que
los presentes en las estaciones posteríores a la represa (Neusa B), sin embargo 
...
los períodos de muestreo.  En el río Frío el gradiente de conductividad es el 
...
ríos, y en general no muestra relación con el gradiente ambiental 
establecido (Figura 3 B). Salvo la estación Fri5, que presenta  una
baja  riqueza de familias , las estaciones del río Frío presentan valores
...
El río Neusa también presenta una diversidad alfa similar entre sus 
estaciones, salvo por la estación Neu7 que presenta una mayor riqueza de 
familias, así como valores más altos de los indices de diversidad. Sin 
embargo, la estructura de las comunidades del río Neusa difiere en gran 
medida de las estaciones del río Frío, puesto que presenta una alta 
...
El análisis de la diversidad beta muestra una diferenciación entre las 
estaciones de ambos ríos, salvo por la estación Fri5 que presenta una 
composición similar a la encontrada en las estaciones del río Neusa (Fig 3 A). 
...
aguas en ambos ríos es de dudosa calidad, con algunas estaciones presentando un estado 
critico (Fig 3 B). Los valores de estos indices son en general inconsistentes 
con el patrón ambiental observado y con los grupos generados por el análisis 
...
hábitos natatoríos o excavadores (Fig 4 D, E y F). Cuando la acidez y la turbidez
...
Las comunidades que se encuentran en las estaciones del río Neusa y del río Frío
muestran variaciones en su composición, siendo las mayores diferencias las que se
encuentran en términos de abundancia relativa de los dípteros y anfípodos presentes
en sus estaciones (Tabla 3).

En el río Neusa, las comunidades presentes en las estaciones anteríores (FríoA)  y
posteríores (FríoB) a la represa son similares y se encuentran en gran parte
conformadas por las familias Chironomidae (40-50%) y  Simuliidae (20-40%), esta
última abundante en aguas limpias y bien oxigenadas (Ríos-Touma et al., 2014).
Mientras que en las estaciones río arriba de la represa es posible encontrar
tanto familias de aguas limpias como Leptoceridae, también es posible encontrar
familias en mayor o menor medida resistentes a la polución como los bivalvos
Sphaeriidae y los dípteros Tipulidae, en las estaciones río abajo es posible
encontrar familias tolerantes a la polución como son Baetidae, Aeshnidae y
Naididae, evidenciando que las estaciones río arriba se encuentran ligeramente
en mejor estado.

Las estaciones del río Frío se caracterizan por poseer una fauna de macroinvertebrados
dominada por amphipodos Hyalellidae y gasterópodos de la familia Physidae que
comprenden 60-80% de las comunidades, siendo los insectos poco abundantes en sus
aguas. Si bien, los insectos suelen representar gran parte de los macroinvertebrados
en los ríos tropicales de alta montaña (Dudgeon, 2008), no es infrecuente que
otros grupos de macroinvertebrados sean los organismos dominantes (Ward, 1994;
Turcotte y Harper, 1982). La familia Hyalellidae suele ser un organismo frecuente
en ambientes lénticos y lóticos de alta montaña (Jacobson y Marin, 2007), siendo
considerado un organismo resistente a la contaminación (Jacobsen y  Encalada, 1998;
...
(Forero,2017), en los que ,en condiciones fisicoquímicas similares a las reportadas
en las estaciones muestreadas, la presencia de Chironomidae fue mucho mayor,
siendo una de los taxones dominante en las comunidades.

Al observarse los índices de diversidad de Shannon y Simpson (Fig 3 B), se observa
que las estaciones presentan valores cercanos, sin que se vea una clara  relación
con el análisis de cluster de las variables fisicoquímicas, y con el gradiente
ambiental observado (Fig 2 A y B).

El análisis de diversidad beta (Fig 3A), muestra que las comunidades de macroinvertebrados
de ambos ríos son diferentes, con la excepción de la estación Fri 5 que tiene
una composición más parecida a la presente en el río Neusa. La estación Fri5,
ubicada en el municipio de Chía, presenta unas condiciones muy  diferentes a las
demás estaciones del río Frío. En esta estación, la comunidad se encuentra
representada en gran parte por Chironomidae y por Hirudíneos, siendo la presencia
de los amphipodos muy reducida. Si bien, los índices de diversidad presentan
valores más altos en esta estación respecto a las demás del río Frío, el bajo
número de familias e individuos por muestreo, indican que esta estación
presenta una muy baja diversidad.


### Respuesta funcional

Cuando se habla de organización funcional de una comunidad, uno de los rasgos
mejor estudiados de las comunidades de macroinvertebrados son los  grupos funcionales
de alimentación (FFG), siendo a menudo utilizados en el monitoreo ambiental de la
Calidad de las aguas (Tomanova et al., 2006; Pinilla 2010; Vera-Sanchez y Pinilla, 2020).
Si bien, en el presente trabajo no fue posible establecer correlaciones significativas
entre las variables medioambientales y la mayoria de las  categorias de los
rasgos funcionales (Anexo 4), vale la pena mencionar algunas tendencias observadas
en los FFG de las comunidades trabajadas.

Como se ve en el análisis RLQ (Fig 4B), Los organismos colectores-recolectores no
tienen una relación fuerte con ninguna de las variables medioambientales, siendo
además muy abundantes en todas las estaciones (Chironomidae en el río Neusa y
Hyalellidae en el río Frío). Los organismos colectores-recolectores han sido
relacionados con sitios contaminados en ríos tropicales de tierras bajas, así
como en ríos de zonas templadas (Usseglio-Polatera y Beisel, 2002; Lecerf et al.,
2006, Tomanova et al., 2008), pese a esto, en ríos tropicales de alta montaña
se consideran organismos bastante frecuentes usualmente representando una gran
parte de las comunidades de macroinvertebrados (Dudgeon, 2008), por lo cual no es
extraño encontrarlos a lo largo de todo el gradiente ambiental.

Existe una tendencia en los ríos tropicales de alta montaña a una alta diversidad
de los organismos predadores (Dudgeon, 2008), siendo esto también observado en
los ríos frío y Neusa, donde las familias predadoras representan aproximadamente
un 37% del total de familias encontradas. Los organismos trituradores fueron en
general poco abundantes y poco diversos en la mayoría de las estaciones, siguiendo
un patrón que se ha observado en las aguas tropicales en general (Dudgeon, 2008),
sin embargo en la estación Frío 4, son un poco más frecuentes, posiblemente
relacionado con la hojarasca producida por  la vegetación aledaña al río
(principalmente Eucaliptos), muy abundante en esta estación.

Debido a la falta de información a nivel taxonómico y ecológico de los macroinvertebrados
de las aguas subtropicales, el método 'fuzzy coding' ha permitido el desarrollo
de herramientas de monitoreo a nivel de familia que permiten  evaluar los
patrones de cambio de la diversidad funcional a lo largo de gradientes de contaminación
ambiental (Usseglio-Polatera et al., 2000; Tomanova et al., 2008). Si bien, este
nivel de resolución taxonómica ha demostrado ser una buena alternativa a el uso
de las especies en estudios de ecología tropical (Melo, 2005), la alta diversidad
ecológica y fisiológica que presentan familias como Chironomidae, pueden limitar
este enfoque en los estudios de diversidad funcional.

Nuevos estudios a nivel de género en las comunidades de macroinvertebrados de
los ríos de la Sabana de Bogotá pueden permitir el desarrollo de alternativas al
'fuzzy coding' como la presentada por Colzani et al. (2013) basada tambien en
categorías, pero que permite el cálculo de índices funcionales como la riqueza,
la igualdad o la divergencia funcional. Estos índices pueden ser fácilmente integrados
en índices multimetricos de biomonitoreo  (Saito et al., 2014).


## Conclusiones

En los ríos Frío y Neusa fue posible identificar cuatro zonas con diferencias en
sus características físicoquímicas, el curso alto del río neusa presenta aguas
...
Las estructura de las comunidades por su parte muestra que las comunidades de los
macroinvertebrados variaron entre los dos ríos, cambiando su fauna dominante, y
las familias presentes. En el río Neusa no hay mayores diferencias entre las
comunidades río arriba y río abajo de la represa. El río Frío por su parte si
presenta diferencias entre las estaciones ubicadas en Cajicá y la estación que se
encuentra en el municipio de Chía, teniendo esta última una muy baja riqueza de
familias.

Es posible establecer la existencia de una relación entre Los rasgos funcionales
de las comunidades de macroinvertebrados y el gradiente ambiental observado, sin
embargo estas relaciones son débiles, puesto que en general no presentan una
correlación con las variables medioambientales medidas . El presente trabajo
representa una primera aproximación para el estudio de la diversidad funcional
en los ríos de la Sabana de Bogotá, siendo necesarios nuevos estudios a nivel
de Género que contribuyan a profundizar en el tema.
