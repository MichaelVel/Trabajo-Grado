---
title: SELECCIÓN DE RASGOS FUNCIONALES DE LAS COMUNIDADES DE MACROINVERTEBRADOS PARA
  SU USO COMO VARIABLES INDICADORAS DE CALIDAD EN DOS RÍOS DE LA SABANA DE BOGOTÁ
...
%Limitaciones método tradicional // Expandir un poco
...
%Rasgos funcionales como alternativa // Revisar
...
se ha desarrollado un enfoque funcional para el biomonitoreo de sistemas lóticos, 
principalmente en zonas templadas, con algunos ejemplos en el  Neotrópico
(Tomanova et al., 2008). Un primer paso para el desarrollo de un índice biológico
de invertebrados con un enfoque funcional de los ríos de la sabana de Bogotá, es
la evaluación de los rasgos funcionales de las comunidades de dichos macroinvertebrados 
para conocer qué rasgos podrían responder mejor a los cambios en los parámetros
fisicoquímicos e hidrológicos de los cursos de agua, por lo que es necesario empezar
a abordar este tipo de acercamientos en los ecosistemas acuáticos colombianos.

%Perspectivas regionales y en el pais // Revisar 
...
% Definición de objetivos // Revisar ¿Establecer pregunta?

En el presente trabajo se busca evaluar la respuesta de los rasgos funcionales 
de las comunidades de macroinvertebrados a la variación  en la calidad del 
agua de los rios de la Sabana de Bogotá y comparar esta respuesta con las mediciones
obtenidas con los tradicionales indices biológicos. 
