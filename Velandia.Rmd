...
Con el fin de establecer el gradiente ambiental, se realizo un análisis de cluster
y un análisis de componentes principales (PCA), para establecer diferencias entre
las condiciones fisicoquimicas de las estaciones se realizo un análisis de 
varianza multivariado (MANOVA). La evaluación de la respuesta de los rasgos 
funcionales al gradiente ambiental se realizo con un análisis de coinercia RLQ,
...
se realizo un análisis *fourth corner* (Dray y Legendre, 2008). Todos los analisis 
fueron realizados en el software R version 3.6.3 (R Core Team, 2020), utilizando
